  ...
  return (
    <BrowserRouter>
      ...
      <footer className="container mt-4 mb-4">
        <div className="footer-note">Octofit Tracker — demo frontend connected to Django REST API</div>
      </footer>
    </BrowserRouter>
  );
}
...
function Home() {
  return (
    <div className="card card-custom p-4">
      ...
      <p className="lead">Browse activities, teams, users, workouts and the leaderboard.</p>
    </div>
  );
}
import React from 'react';
